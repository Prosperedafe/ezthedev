<template>
    <header class="fixed w-full z-10 backdrop-blur-[6px]">
        <nav class="flex justify-between items-center px-[5%] py-2">
            ...
            <button @click="toggleActiveStyle(contactStyles)"
                class="flex items-center bg-primaryText rounded-[25px] text-white gap-2 px-6 py-3 text-base">
    ...
    <div ref="contactRef" :class="[
        ...
        { 'opacity-100 pointer-events-all': isActive }
    ]">
        <section class="bg-white rounded-[25px] p-4 w-full max-w-[463px]">
            <button @click="toggleActiveStyle(contactStyles)" class="block ml-auto mb-2">
